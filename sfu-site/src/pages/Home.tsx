...
export const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <Panel />
      <main className='z-0 pt-[130px] max-[560px]:pt-[100px] max-[940px]:pt-[110px] max-[520px]:px-[20px] max-[1130px]:ml-0 
        max-[1130px]:pl-[105px] max-[940px]:px-[50px] max-[720px]:px-[20px] ml-[25%] pl-[50px] pr-[105px]'>
        {form ? <div className='max-[400px]:pb-[60px]'><CreateQuestion /></div> : <Questions />}
      </main>
