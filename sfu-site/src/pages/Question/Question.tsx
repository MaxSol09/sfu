...
export const Question: React.FC = () => {
  ...
  return (
    ...
    <Panel />
    <main className='z-0 pt-[130px] ml-[27%] pr-[100px] max-[1130px]:ml-[0%] max-[1130px]:px-[100px] max-[950px]:px-[50px] 
      max-[950px]:pt-[120px] max-[540px]:pt-[110px] max-[520px]:px-[20px]'>
      {!loadingQuestion ? (
