   ...
   return (
     <div className='h-[100vh] flex w-full bg-cover' style={{backgroundImage: width < 700 ? `url(${Sfu2})` : ''}}>
       ...
       <div className='flex flex-col mt-[20vh] w-1/2 items-center max-[700px]:w-full'>
        <div className='w-full rounded-[20px] flex flex-col justify-center items-center max-[700px]:shadow-custom-rounded max-[700px]:bg-white max-[700px]:w-[70%] max-[700px]:py-[30px] max-[400px]:w-[80%]'>
