...
export const Header: React.FC<Props> = ({currPage}) => {
  ...
  return (
    <>
    <header className='fixed bg-white border-b-[2px] z-20 flex py-[20px] px-[70px] max-[1300px]:px-[100px] max-[940px]:px-[50px] max-[720px]:px-[10px] w-full items-center gap-[20px] max-[500px]:gap-[10px] max-[1130px]:px-[105px] justify-around'>
